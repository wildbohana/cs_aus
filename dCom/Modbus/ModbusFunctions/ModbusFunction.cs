...
namespace Modbus.ModbusFunctions
{
    ...
    public abstract class ModbusFunction : IModbusFunction
	{
		...
		protected void CheckArguments(MethodBase m, Type t)
		{
			...
			{
				string message = $"{m.ReflectedType.Name}{m.Name} has invalid argument {nameof(commandParameters)} of type {commandParameters.GetType().Name}.\nArgumet type should be {t.Name}";
